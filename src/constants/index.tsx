...
export const navLinks = [
  { href: "/dashboard/settings", label: "Company Settings", icon: <Settings className="h-5 w-5" /> },
  { href: "/dashboard/services", label: "Services", icon: <ClipboardList className="h-5 w-5" /> },
  { href: "/dashboard/uniqueness", label: "Why Choose Us", icon: <Star className="h-5 w-5" /> },
  { href: "/dashboard/portfolio", label: "Portfolio", icon: <Briefcase className="h-5 w-5" /> },
  { href: "/dashboard/partners", label: "Partners", icon: <Handshake className="h-5 w-5" /> },
  { href: "/dashboard/presence", label: "Global Presence", icon: <Globe className="h-5 w-5" /> },
  { href: "/dashboard/team", label: "Our Team", icon: <Users className="h-5 w-5" /> },
  { href: "/dashboard/contacts", label: "Contacts", icon: <Phone className="h-5 w-5" /> },
  { href: "/dashboard/account-settings", label: "Account Settings", icon: <UserCog className="h-5 w-5" /> },
];
...
// Updated helper function to return JSX element properly
export const getIconComponent = (iconName: string, className: string = "h-5 w-5"): React.ReactElement => {
