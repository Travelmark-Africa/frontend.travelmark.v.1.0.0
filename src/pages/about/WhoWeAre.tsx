...
import { missionImage, aboutImage1, aboutImage2, aboutImage3 } from '@/assets';
              ...
              <div className='max-w-xl'>
                <div className='backdrop-blur-2xl rounded-2xl p-8'>
                  ...
                  <p className='text-white/90 text-base leading-relaxed'>
                    TravelMark Africa is a Kigali-based firm driving Africa's growth in business tourism. We specialize in event consultation, MICE strategy, and capacity development to help African countries unlock their global potential.
                  </p>
          ...
          <Container>
            <div className="text-center space-y-2 mb-8">
              <h1 className="text-2xl md:text-4xl font-extrabold text-gray-900 leading-tight">
                You can always{' '}
                <span className="text-primary font-primary">trust us</span>
                <br />
                with your special moments
              </h1>

              <p className="text-[0.9rem] text-gray-600 max-w-xl mx-auto leading-relaxed">
                We transform ideas into impactful business events through strategic consultation, MICE planning, and execution.
              </p>
            </div>
          </Container>
                  ...
                  <div className="h-full rounded-2xl overflow-hidden bg-gray-200 relative">
                    ...
                    <div className="absolute bottom-3 left-3 z-20">
                      <div className="bg-black/60 backdrop-blur-sm rounded-lg px-2 py-1">
                        <h3 className="text-white font-semibold text-[0.8rem] pb-1">MICE Consultation & Event Management</h3>
                        <p className="text-white/80 text-xs">We develop strategies and manage global-scale business events.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 lg:gap-4 h-full">
                  ...
                  <div className="relative group flex-1">
                    <div className="h-full rounded-2xl overflow-hidden bg-gray-200 relative">
                      ...
                      <div className="absolute bottom-2 left-2 z-20">
                        <div className="bg-black/60 backdrop-blur-sm rounded-lg px-2 py-1">
                          <h3 className="text-white font-semibold text-[0.8rem] pb-1">Destination Marketing & Branding</h3>
                          <p className="text-white/80 text-xs">We promote countries as leading business tourism destinations.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group flex-1">
                    <div className="h-full rounded-2xl overflow-hidden bg-gray-200 relative">
                      ...
                      <div className="absolute bottom-2 left-2 z-20">
                        <div className="bg-black/60 backdrop-blur-sm rounded-lg px-2 py-1">
                          <h3 className="text-white font-semibold text-[0.8rem] pb-1">Capacity Building & Engagement</h3>
                          <p className="text-white/80 text-xs">We train, connect, and empower professionals across Africa.</p>
                        </div>
                      </div>
                    </div>
                  </div>
