      ...
      <Dialog open={isOpen} onOpenChange={handleClose}>
        <DialogContent className="sm:max-w-xl mx-4 md:mx-auto">
          ...
          <div className="grid gap-6 py-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                      className="w-full justify-start text-left font-normal rounded-md shadow-none py-5"
                    >
            ...
            <div className="space-y-2">
              <Label htmlFor="tag" className="text-sm font-medium">Destination Type</Label>
          ...
          <div className="flex justify-end">
            <Button
              ...
              className="bg-rose-500 hover:bg-rose-600 text-white px-6 py-5"
              disabled={isLoading}
            >
              Search
            </Button>
